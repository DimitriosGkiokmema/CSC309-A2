...
export default function Transactions() {
    ...
    async function loadTransactions() {
        ...
        if(res.status !== 200) {
                console.log("this is not a 200 return");
                setSearch(false);
            ...
            console.log("this IS a 200 return");
            ...
            setSearch(false);
            setMessage("");
            console.log("this is actually completely fine");
            if(limit) {
    ...
    async function myTransactions() {
        ...
        if(res.status !== 200) {
            setSearch(false);
            if(role !== "manager") {
                setError("Transaction not found: " + res.data.error);
            }
            if(message) {
    ...
    async function searchRedemption(e) {
            e.preventDefault();
            setMessage("");
            ...
            if(txId && txId.trim() !== "") {
                ...
                else if(res.data.type !== "redemption") {
                    // console.log(res.data);
                    setSearch(true);
                    setMessage("TransactionId doesn't match a redemption transaction!");
                }
                else {
                    // console.log(res.data);
                    setSearch(true);
                    setRedemptions([res.data]); // put the single tx in an array
                }
            }
    }
        ...
        if(!search) {
            ...
            <div className="col-8 offset-2">
                ...
                <div className="txSearch">
                    ...
                    />
                    <input type="button" value="Search" onClick={searchRedemption}/>
                    </div>
